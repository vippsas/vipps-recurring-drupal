 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/vipps/vipps_agreements/{vipps_agreements}",
 *     "add-form" = "/admin/vipps/vipps_agreements/add",
 *     "edit-form" = "/admin/vipps/vipps_agreements/{vipps_agreements}/edit",
 *     "delete-form" = "/admin/vipps/vipps_agreements/{vipps_agreements}/delete",
 *     "version-history" = "/admin/vipps/vipps_agreements/{vipps_agreements}/revisions",
 *     "revision" = "/admin/vipps/vipps_agreements/{vipps_agreements}/revisions/{vipps_agreements_revision}/view",
 *     "revision_revert" = "/admin/vipps/vipps_agreements/{vipps_agreements}/revisions/{vipps_agreements_revision}/revert",
 *     "revision_delete" = "/admin/vipps/vipps_agreements/{vipps_agreements}/revisions/{vipps_agreements_revision}/delete",
 *     "collection" = "/admin/vipps/vipps_agreements",
 *   },
