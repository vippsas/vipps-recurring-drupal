 ...
 *       "request" = "Drupal\vipps_recurring_payments\Form\VippsAgreementsRequestCancelForm",
 ...
 *     "request-cancel-form" = "/user/{user}/vipps-agreement-list/{vipps_agreements}/cancel",
