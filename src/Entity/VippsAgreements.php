 ...
 *     "add-form" = "/admin/structure/vipps/vipps_agreements/add",
 *     "edit-form" = "/admin/structure/vipps/vipps_agreements/{vipps_agreements}/edit",
 *     "delete-form" = "/admin/structure/vipps/vipps_agreements/{vipps_agreements}/delete",
 *     "version-history" = "/admin/structure/vipps/vipps_agreements/{vipps_agreements}/revisions",
 *     "revision" = "/admin/structure/vipps/vipps_agreements/{vipps_agreements}/revisions/{vipps_agreements_revision}/view",
 *     "revision_revert" = "/admin/structure/vipps/vipps_agreements/{vipps_agreements}/revisions/{vipps_agreements_revision}/revert",
 *     "revision_delete" = "/admin/structure/vipps/vipps_agreements/{vipps_agreements}/revisions/{vipps_agreements_revision}/delete",
 *     "collection" = "/admin/structure/vipps/vipps_agreements",
 *   },
